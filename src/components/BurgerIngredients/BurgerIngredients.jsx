...
const BurgerIngredients = ({ onIngredientClick }) => {
  return (
    <div className={`${burgerIngredientsStyles.burgerIngredients}  mr-10 mt-10`}>
      ...
      <div className={`${burgerIngredientsStyles.ingredientTypes} ingredientTypes custom-scroll`}>
        <h3 className="text text_type_main-medium mt-10 mb-6">Булки</h3>
        <IngredientsContainer type="bun" onIngredientClick={onIngredientClick} />
        <h3 className="text text_type_main-medium mt-10 mb-6">Соусы</h3>
        <IngredientsContainer type="sauce" onIngredientClick={onIngredientClick} />
        <h3 className="text text_type_main-medium mt-10 mb-6">Главное</h3>
        <IngredientsContainer type="main" onIngredientClick={onIngredientClick} />
      </div>
    </div>
  );
};
